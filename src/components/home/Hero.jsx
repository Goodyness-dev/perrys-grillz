  ...
  const heroSlides = [
    {
      ...
      headlineTop: "Taste of",
      headlineBottom: "Paradise",
  ...
  return (
    <section className="relative pt-2 pb-10 sm:pb-16 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="w-full relative h-[420px] sm:h-[520px] md:h-[600px] lg:h-[640px] rounded-3xl sm:rounded-[2.5rem] overflow-hidden shadow-2xl bg-charcoal-950 border border-amber-900/30 group">
          ...
          {/* Warm Gradients & Ambient Dark Shading */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/45 to-black/30 pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0)_20%,rgba(15,12,8,0.7)_100%)] pointer-events-none" />
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 sm:px-12 z-10">
            ...
            {/* Subtitle Pill */}
            <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-white/15 backdrop-blur-md border border-white/20 text-amber-100 text-[11px] sm:text-xs tracking-[0.25em] uppercase font-medium mb-4 sm:mb-6 shadow-sm">
            ...
            {/* Tagline */}
            <p className="mt-4 sm:mt-6 text-sm sm:text-lg md:text-xl text-stone-200 font-light max-w-2xl tracking-wide leading-relaxed drop-shadow">
            ...
            <div className="mt-7 sm:mt-9 flex flex-wrap items-center justify-center gap-4">
              <button
                ...
                className="rounded-full bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold px-8 py-3.5 text-xs sm:text-sm uppercase tracking-[0.2em] transition-all duration-300 shadow-xl active:scale-95 cursor-pointer"
              >
                RESERVE A TABLE
              </button>
              ...
              <a
                href="#menu-showcase"
                className="rounded-full bg-black/50 hover:bg-black/70 text-amber-100 border border-amber-400/40 backdrop-blur-md px-7 py-3.5 text-xs sm:text-sm font-semibold uppercase tracking-[0.18em] transition-all duration-300 shadow-lg active:scale-95 cursor-pointer"
              >
                EXPLORE MENU
              </a>
            </div>
            ...
            {heroSlides.map((_, idx) => (
              <button
                ...
                className={`transition-all duration-300 rounded-full ${
                  slideIndex === idx ? 'w-8 h-2 bg-amber-400' : 'w-2 h-2 bg-white/50 hover:bg-white/80'
                }`}
